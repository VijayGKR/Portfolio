        ...
        <div className="space-y-6 sm:space-y-8">
          {projects.map((project, index) => (
            <Link href={project.link} key={index}>
              <div className="border border-gray-700 p-4 sm:p-6 rounded-lg hover:bg-gray-900 transition duration-300 flex flex-col sm:flex-row justify-between items-center">
